pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~prog3.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~prog3.adb");
...
package body ada_main is
   ...
   is
      ...
      pragma Import (Ada, Ada_Main_Program, "_ada_prog3");
...
--  BEGIN Object file/option list
   --   ./prog3.o
   --   -L./
   --   -L/usr/local/gnat/lib/gcc/x86_64-apple-darwin9.6.0/4.3.6/adalib/
   --   -static
   --   -lgnat
